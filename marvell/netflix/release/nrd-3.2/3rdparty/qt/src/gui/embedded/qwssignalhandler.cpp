...
{
#ifdef EUREKA
    // Disables QT signal handling. If QT_NO_QWS_SIGNALHANDLER is not defined,
    // QT cannot initialize directfb driver properly.
#else
    const int signums[] = { SIGQUIT, SIGILL, SIGABRT, SIGFPE, SIGSEGV, SIGBUS };
