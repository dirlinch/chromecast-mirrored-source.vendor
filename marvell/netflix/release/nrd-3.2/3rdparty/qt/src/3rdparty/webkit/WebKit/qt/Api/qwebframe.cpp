...
{
    addToJavaScriptWindowObject(name, object, Qt::ValueOwnershipQt);
}
...
*/
void QWebFrame::addToJavaScriptWindowObject(const QString &name, QObject *object, Qt::ValueOwnership ownership)
{
