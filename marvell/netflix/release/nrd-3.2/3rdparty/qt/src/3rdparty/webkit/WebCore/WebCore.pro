...
unix:!mac:*-g++* {
    ...
    linux-armv6-g++:LINKER_SCRIPT=armv6-linker.ld
    linux-x86-g++:LINKER_SCRIPT=i686-linker.ld
    #linux-mips-brcm-7468-g++:LINKER_SCRIPT=mipsel7468-linker.ld
    !isEmpty(LINKER_SCRIPT) {
        QMAKE_LFLAGS += -L$$PWD/.. -Wl,-T,$$PWD/../$$LINKER_SCRIPT
        POST_TARGETDEPS += $$PWD/../$$LINKER_SCRIPT $$PWD/../libQtWebKit.ld
    }
}
...
!contains(DEFINES, ENABLE_JAVASCRIPT_DEBUGGER=0):!symbian:!maemo5 {
