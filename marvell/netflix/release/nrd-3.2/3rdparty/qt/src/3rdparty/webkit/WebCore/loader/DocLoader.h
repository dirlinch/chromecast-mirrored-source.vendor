...
public:
    ...
    CachedResource* cachedResource(const String& url) const { return m_documentResources.resourceForURL(url); }
    
    typedef SubCache::ResourceMap DocumentResourceMap;
    DocumentResourceMap allCachedResources() const { return m_documentResources.allResources(); }
...
private:
    ...
    Cache* m_cache;
    SubCache m_reloadedURLs;
    mutable SubCache m_documentResources;
    Document* m_doc;
