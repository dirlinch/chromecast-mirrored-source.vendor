...
public:
    ...
    bool canDelete() const { return !m_cancellingRequest && !hasClients() && !m_request && !m_preloadCount && !m_handleCount && !m_resourceToRevalidate && !m_proxyResource; }
