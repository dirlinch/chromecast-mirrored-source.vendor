...
public:
    ...
    */
    ...
    static bool m_noNeedRecalcStyleFlag1;
    static bool m_noNeedRecalcStyleFlag2;

    static void setNoNeedRecalcStyleFlag1();
    static void resetNoNeedRecalcStyleFlag1();
    static void setNoNeedRecalcStyleFlag2();
    static void resetNoNeedRecalcStyleFlag2();
    static bool isNoNeedRecalcStyle();
