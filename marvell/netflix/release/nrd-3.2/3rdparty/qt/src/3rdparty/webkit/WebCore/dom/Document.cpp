...
bool Document::m_noNeedRecalcStyleFlag1 = false;
bool Document::m_noNeedRecalcStyleFlag2 = false;
...
#endif
    Document::setNoNeedRecalcStyleFlag2();
}
...
void Document::setNoNeedRecalcStyleFlag1()
{
    Document::m_noNeedRecalcStyleFlag1 = true;
}

void Document::resetNoNeedRecalcStyleFlag1()
{
    Document::m_noNeedRecalcStyleFlag1 = false;
}

void Document::setNoNeedRecalcStyleFlag2()
{
    Document::m_noNeedRecalcStyleFlag2 = true;
}

void Document::resetNoNeedRecalcStyleFlag2()
{
    Document::m_noNeedRecalcStyleFlag2 = false;
}

bool Document::isNoNeedRecalcStyle()
{
    return Document::m_noNeedRecalcStyleFlag1 && Document::m_noNeedRecalcStyleFlag2;
}
