...
public:
    ...
    static PassRefPtr<QtInstance> getQtInstance(QObject*, PassRefPtr<RootObject>, Qt::ValueOwnership ownership);
...
private:
    static PassRefPtr<QtInstance> create(QObject *instance, PassRefPtr<RootObject> rootObject, Qt::ValueOwnership ownership)
    {
    ...
    QtInstance(QObject*, PassRefPtr<RootObject>, Qt::ValueOwnership ownership); // Factory produced only..
