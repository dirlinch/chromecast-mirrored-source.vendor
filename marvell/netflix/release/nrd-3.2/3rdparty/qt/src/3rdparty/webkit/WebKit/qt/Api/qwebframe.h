...
public:
    ...
    void addToJavaScriptWindowObject(const QString &name, QObject *object, Qt::ValueOwnership ownership);
#ifndef QT_NO_SCRIPT
    inline void addToJavaScriptWindowObject(const QString &name, QObject *object, QScriptEngine::ValueOwnership ownership) 
    {
        addToJavaScriptWindowObject(name, object, (Qt::ValueOwnership)ownership); 
    }
#endif
...
private:
    ...
    friend class WebCore::PlatformLayerQWidget;
    QWebFramePrivate *d;
};
